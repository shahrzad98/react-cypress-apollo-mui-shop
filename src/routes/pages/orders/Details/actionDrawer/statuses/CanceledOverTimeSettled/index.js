...
const CanceledOverTimetSettled = ({ close }) => {
  ...
  return (
    <Style container>
      <Grid container>
        <h3>درخواست منقضی شده</h3>
      </Grid>
      <Grid justifyContent="center" container>
        <FailedSVG style={{ marginRight: '-50px' }} />
      </Grid>
      <Grid container>
        <p>درخواست مشتری برای ثبت سفارش، بدلیل عدم تایید شما منقضی شده است.</p>
      </Grid>
...
export default CanceledOverTimetSettled;

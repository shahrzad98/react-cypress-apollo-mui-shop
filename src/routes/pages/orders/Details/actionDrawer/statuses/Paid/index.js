      ...
      case 1: {
        return (
          <>
            {' '}
            <Grid container>
              <p>در صورت آماده بودن محصولات، سفارش را تایید کنید.</p>
            </Grid>
          </>
        );
      }
              ...
              >
                ...
                >
                  {DECLINE_REASONS.map((item, i) => (
                    <MenuItem
                      data-cy={`decline_order_option_${i}`}
                      key={i}
                      value={item.value}
                    >
                      <Radio
      ...
      case 3:
        return (
          <Grid container>
            ...
            <Grid container>
              <p>
                سفارش جدیدی ثبت شده و تا 24 ساعت رزرو می شود و در انتظار تایید
                شما است. لطفا برای جلوگیری از منقضی شدن سفارش ، در سریع ترین
                زمان، وضعیت آن را بررسی کنید.{' '}
              </p>
            </Grid>
          </Grid>
        );

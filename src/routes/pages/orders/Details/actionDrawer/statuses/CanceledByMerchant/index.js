...
const CanceledByMerchantSettled = ({ close, order, changeStatus }) => {
  ...
  return (
    <Style container>
      ...
      <Grid container>
        <p>
          سفارش مشتری بدلیل عدم تایید شما رد شده است. لطفا در صورت واریز مبلغ به
          حسابتان، مبلغ پرداخت شده را، به حساب مشتری برگردانید{' '}
        </p>
      </Grid>

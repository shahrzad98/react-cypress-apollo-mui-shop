      ...
      case 3: {
        return (
          <Grid alignItems="center" container>
            ...
            <h3 onClick={() => setStep(2)}>حساب کاربری دیجی اکسپرس</h3>
          </Grid>
        );
      }
      case 4: {
      ...
      case 1: {
        if (isEdit) {
          ...
          return (
            <Grid container>
              <Grid container>
                <h2>اطلاعات مرسوله - دیجی‌اکسپرس</h2>
              </Grid>
              <Grid container>
                <p>
                  پس از انتخاب موارد زیر با استفاده از دکمه &quot;تایید
                  اطلاعات&quot; می توانید هزینه ارسال دیجی‌اکسپرس را مشاهده
                  کنید.
                </p>
              </Grid>
              <Grid container>
          ...
          <Grid container>
            ...
            <Grid mt={3} container className="address-container">
              ...
              <Grid mt={2} justifyContent="space-between" container>
                ...
                {sendOrder?.approximate_post_cost == -2 ? (
                  <h4 style={{ color: '#EA002A' }}>
                    <RefreshSVG onClick={() => refetchOrder()} /> مشکلی پیش آمده
                  </h4>
                ) : (
                  <h4>
                    <RefreshSVG onClick={() => refetchOrder()} />{' '}
            ...
            <Grid
              ...
              container
            >
              <p style={{ margin: 0 }}>در حال جستجوی سفیر دیجی‌اکسپرس...</p>
              <Button
                endIcon={
                  <i
      ...
      case 4: {
        return (
          <Grid container>
            ...
            <Grid mt={3} container>
              <p>
                سفیر دیجی‌اکسپرس یافت شده . در صورت تحویل مرسوله به مشتری ،
                وضعیت سفارش تحویل شده قرار میگیرد.
              </p>
            </Grid>
            ...
            >
              <Grid item xs={6}>
                ...
                >
                  {safirData?.digiexpress_agent_info?.avatar?.url ? (
                    <img src={safirData?.digiexpress_agent_info?.avatar?.url} />
                  ) : (
                    <UserSVG />
                  )}
                </div>
              ...
              <Grid style={{ textAlign: 'end' }} item xs={6}>
                ...
                >
                  {safirData?.digiExpress_agent_info?.firstname
                    ? safirData?.digiexpress_agent_info?.firstname +
                      ' ' +
                      safirData?.digiexpress_agent_info?.lastname
                    : 'نامشخص'}
                ...
                >
                  {safirData?.digiexpress_agent_info?.phone
                    ? safirData?.digiexpress_agent_info?.phone
                    : 'نامشخص'}

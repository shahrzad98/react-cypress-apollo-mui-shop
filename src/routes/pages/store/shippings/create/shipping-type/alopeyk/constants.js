...
export const STEP_CONTENT = [
  {
    title: 'ساخت حساب کاربری الوپیک',
    desc: 'برای فعال سازی روش ارسال الوپیک ، لطفا اطلاعات زیر را وارد کنید.'
  },
  {
...
export const PAYMENT_TIME = [
  {
    ...
    detail:
      '(هزینه ارسال پرداخت شده هنگام ثبت سفارش , ممکن است با هزینه ارسال محاسبه شده توسط الوپیک هنگام ارسال سفارش ، متفاوت باشد.)',
    value: false
  },
  {
    title: 'پس پرداخت',
